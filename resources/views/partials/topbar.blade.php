<nav class="bg-gray-50 z-10 p-5 px-10 h-[90px] left-[320px] w-[calc(100%-320px)] flex items-center fixed top-0">
    ...
    <div class="flex-[1] flex justify-end relative">
        <button id="profileButton" class="size-12 bg-gray-300 rounded-full flex items-center justify-center focus:outline-none overflow-hidden">
            <img src="{{ asset('imgs/1.png') }}" 
                 alt="Profil" 
